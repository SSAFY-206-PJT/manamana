      ...
      <div style={coverStyle} className="absolute h-auto w-full">
        ...
        <div className="grid h-96 grid-cols-2">
          <div className="mx-3 grid grid-cols-2">
            <p className="font-semibold text-FontPrimaryDark opacity-80 ">연재시작일</p>
            <p className="text-FontPrimaryDark  ">
              {dummyWebtoon.startDate.toISOString().split('T')[0]}
            </p>
            <p className="font-semibold text-FontPrimaryDark opacity-80 ">연재정보</p>
            <p className="text-FontPrimaryDark  ">{dummyWebtoon.status}</p>
            <p className="font-semibold text-FontPrimaryDark opacity-80 ">조회수</p>
            <p className="text-FontPrimaryDark  ">{dummyWebtoon.additions.view}</p>
            <p className="font-semibold text-FontPrimaryDark opacity-80 ">평가수</p>
            <p className="text-FontPrimaryDark  ">{dummyWebtoon.additions.scoreCount}</p>
          </div>
          <div>
            <p>평점</p>
            <p>{dummyWebtoon.additions.scoreAverage}</p>
          </div>
        </div>
        <hr className="white my-6 border-white bg-white" />
        <div className="h-96"></div>
