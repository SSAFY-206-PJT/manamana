...
public class RecommandServiceImpl implements RecommandService {
    ...
    public List<RecommandWebtoonResponseDTO> recommandUserWebtoon(long userId) throws Exception {
        ...
        ResponseEntity<String> response = restTemplate.exchange("https://j8b206.p.ssafy.io/fastapi/userbased", HttpMethod.POST, entity, String.class);
    ...
    public  List<RecommandWebtoonResponseDTO> recommandAssociationWebtoon(long webtoonId) throws Exception {
        ...
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> response = restTemplate.exchange("https://j8b206.p.ssafy.io/fastapi/assosiation", HttpMethod.POST, entity, String.class);
